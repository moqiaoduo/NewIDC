            ...
            <form class="layui-form" method="post" action="{{route('login')}}">
                ...
                <div class="layui-form-item">
                    <input type="text" name="username" required lay-verify="required"
                           placeholder="用户名" class="layui-input @error('username') newidc-form-invalid @enderror">
                    @error('username')
                ...
                <div class="layui-form-item">
                    <input type="password" name="password" required lay-verify="required"
                           placeholder="密码" class="layui-input @error('password') newidc-form-invalid @enderror">
                    @error('password')
                    <span class="newidc-form-error">{{$message}}</span>
                    @enderror
                </div>
