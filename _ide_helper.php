 ...
 * Generated for Laravel 6.18.20 on 2020-06-21 19:33:20.
 *
...
namespace NewIDC\Plugin\Facade { 
    ...
    class PluginManager {
         ...
         *
         * @param \NewIDC\Plugin\Plugin $plugin 插件对象
         * @static 
         */ 
         ...
         * @static 
         */ 
        public static function isServerPlugin($id)
        {
                        /** @var \NewIDC\Plugin\Manager $instance */
                        return $instance->isServerPlugin($id);
        }
        ...
        {
                        /** @var \NewIDC\Plugin\Manager $instance */
                        return $instance->getPluginInfo($slug);
        }
...
namespace  { 
    ...
    class PluginManager extends \NewIDC\Plugin\Facade\PluginManager {}
